...
const AllMyNotes: NextPage = () => {
  ...
  const { data, isLoading } = trpc.notes?.allNotes.useQuery();
  const deleteSingleNote = trpc.notes.deleteNote.useMutation({
    onMutate: () => {
...
const Home: NextPage = () => {
  return (
    <>
      ...
      <main className="mx-auto flex min-h-screen flex-col justify-center py-10 sm:container">
