...
const Editnote: NextPage = () => {
  ...
  useEffect(() => {
    setData({
      title: messageDetail?.title as string,
      description: messageDetail?.description as string,
      id: messageDetail?.id as string,
    });
  }, []);

  const updateNewNote = trpc.notes.updateNote.useMutation({
    onMutate: () => {
    ...
    onSettled: () => {
      ...
      utils.notes.detailNote.invalidate();
    },
  });
